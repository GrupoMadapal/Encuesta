...
namespace Poleo.BLL
{
    public class TiemposHistorialBLL
    {
        ...
        public String generateFileDeliveryOrdersHistory1Store(HttpServerUtility server, VentasFinder objVentasFinder, string locationCode)
        {
            ...
            if (xlApp != null)
            {
                ...
                if (temp == "1")                       //Only one Store, selected in the DDL
                {
                    ...
                    this.CreatedContentFileDeliveryOrdersHistory(xlWorkBook.Worksheets.Add(), objfinder, objtienda);
                }
                else
                {
                ...
                nombreArchivo = "TiemposHistorial" + anioNom + ".xlsx";
        ...
        public String generateFileDeliveryOrdersHistory(HttpServerUtility server, VentasFinder objVentasFinder)
        {
            TiendaBLL objTiendasBLL = new TiendaBLL();
            String nombreArchivo = string.Empty;
            OrdenesFinder objfinder = new OrdenesFinder();
            ...
            if (xlApp != null)
            {
                ...
                {
                    IList<Tienda> lstTiendasCompleto = objTiendasBLL.SelectTiendas(objtienda);
                    foreach (Tienda item in lstTiendasCompleto)
                    {
                        ...
                        this.CreatedContentFileDeliveryOrdersHistory(xlWorkBook.Worksheets.Add(), objfinder, item);
                    ...
                    this.CreatedContentFileDeliveryOrdersHistory(xlWorkBook.Worksheets.Add(), objfinder, objTiendaSLP);
                    ...
                    this.CreatedContentFileDeliveryOrdersHistory(xlWorkBook.Worksheets.Add(), objfinder, objTiendaTMPS);
                    ...
                    this.CreatedContentFileDeliveryOrdersHistory(xlWorkBook.Worksheets.Add(), objfinder, objTiendaFRANQ);
                }
        ...
        public void CreatedContentFileDeliveryOrdersHistory(Excel.Worksheet xlWorksheet, OrdenesFinder objfinder, Tienda objTienda)
        {            
