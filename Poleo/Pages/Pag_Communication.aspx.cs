...
{
    public partial class Pag_Communication : System.Web.UI.Page
    {
        ...
        protected void btnAcept_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvwStore.Rows)
            {
                ...
                TextBox txtCommunication = (TextBox)row.FindControl("txtCommunication");
                ...
                else if (findInfo_MasterInd.Communication == null)
                {
