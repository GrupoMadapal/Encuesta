<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PizzasCtrl.ascx.cs" Inherits="Poleo.Controls.PizzasCtrl" %>

<asp:Label runat="server" Text="PIZZAS" Font-Bold="true" Font-Italic="true" Font-Size ="X-Large" > </asp:Label>
<br />
<asp:Panel runat="server" ScrollBars="vertical"  Height="250px" >
    <asp:GridView ID="GridViewPizzas" runat="server" AutoGenerateColumns="True" CellPadding ="4" ForeColor ="#333333" GridLines ="Both" BorderStyle ="Solid" BorderColor ="Black" BorderWidth ="1px" >
